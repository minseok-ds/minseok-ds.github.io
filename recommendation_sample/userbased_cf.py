...
from recommendation import UserBasedCF, build_user_item_matrix
...
# 4. Initialize and fit the recommender
user_based_cf = UserBasedCF()
user_based_cf.fit(
    user_item_matrix, user_ids=pivot_table.index, item_ids=pivot_table.columns
)

# 5. Recommend items for a specific user
user_id = 42
n_recommendations = 10
recommended_items = user_based_cf.recommend(user_id, n_recommendations)
